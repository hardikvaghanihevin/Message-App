...
import com.hardik.messageapp.presentation.custom_view.shadow_lay.ViewHelper.getInnerPath
    ...
    private fun initAttrsLayout(context: Context, attributeSet: AttributeSet, defStyle: Int) {
        ...
        try {
            ...
            stroke = Stroke(
                ...
                this.blurType = BlurMaskFilter.Blur.values().find {
                    it.ordinal == a.getInteger(
            ...
            backgroundBlurType = BlurMaskFilter.Blur.values().find {
                it.ordinal == a.getInteger(
...
//https://github.com/sonsation/android-shadow-layout/tree/master